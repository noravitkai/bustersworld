<footer class="custom-footer">
    <div class="footer-content">
        <div class="contact-info">
            ...
            <p><a target="_blank" href="<?php the_field('organization_url'); ?>"><?php the_field('organization_website'); ?></a></p>
        </div>
        <div class="social-media">
            <h3>Follow Us</h3>
            <a target="_blank" href="<?php the_field('some_1_link'); ?>"><?php the_field('some_1_text'); ?></a>
            <a target="_blank" href="<?php the_field('some_2_link'); ?>"><?php the_field('some_2_text'); ?></a>
        </div>
